...
const HeroBottom = () => {
  ...
  <div className="w-[400px] h-auto p-4 gap-2 rounded-md bg-[#F7F7F7] flex">
    <div className="w-[80px] h-[80px] rounded-md bg-white flex items-center justify-center">
      <Image src="/images/pen-tool-2.png" alt="Logo" className="w-[32px] h-[32px]" />
    </div>
  ...
  <div className="w-[400px] h-auto p-4 gap-2 rounded-md bg-[#F7F7F7] flex">
    <div className="w-[80px] h-[80px] rounded-md bg-white flex items-center justify-center">
      <Image src="/images/volume.png" alt="Logo" className="w-[32px] h-[32px]" />
    </div>
    <div className="flex flex-col gap-1">
  ...
  <div className="w-[400px] h-auto p-4 gap-2 rounded-md bg-[#F7F7F7] flex">
    <div className="w-[80px] h-[80px] rounded-md bg-white flex items-center justify-center">
      <Image src="/images/group.png" alt="Logo" className="w-[32px] h-[32px]" />
    </div>
    <div className="flex flex-col gap-1">
  ...
  {/* Card 4 */}
        ...
        <div className="flex md:flex sm:hidden gap-6 justify-start w-full mt-20">
          ...
          <div className="w-[400px] h-auto p-4 gap-2 rounded-md bg-[#F7F7F7] flex">
            <div className="w-[80px] h-[80px] rounded-md bg-white flex items-center justify-center">
              <Image src="/images/microphone.png" alt="Logo" className="w-[32px] h-[32px]" />
            </div>
            <div className="flex flex-col gap-1">
          ...
          <div className="w-[400px] h-auto p-4 gap-2 rounded-md bg-[#F7F7F7] flex">
            <div className="w-[80px] h-[80px] rounded-md bg-white flex items-center justify-center">
              <Image src="/images/link.png" alt="Logo" className="w-[32px] h-[32px]" />
            </div>
            <div className="flex flex-col gap-1">
          ...
          <div className="w-[400px] h-auto p-4 gap-2 rounded-md bg-[#F7F7F7] flex">
            <div className="w-[80px] h-[80px] rounded-md bg-white flex items-center justify-center">
              <Image src="/images/arrow-2.png" alt="Logo" className="w-[32px] h-[32px]" />
            </div>
            <div className="flex flex-col gap-1">
        ...
        <div className="flex  md:flex sm:hidden gap-6 justify-start w-full mt-20">
          ...
          <div className="w-[400px] h-auto p-4 gap-2 rounded-md bg-[#F7F7F7] flex">
            <div className="w-[80px] h-[80px] rounded-md bg-white flex items-center justify-center">
              <Image src="/images/briefcase.png" alt="Logo" className="w-[32px] h-[32px]" />
            </div>
            <div className="flex flex-col gap-1">
          ...
          <div className="w-[400px] h-auto p-4 gap-2 rounded-md bg-[#F7F7F7] flex">
            <div className="w-[80px] h-[80px] rounded-md bg-white flex items-center justify-center">
              <Image src="/images/book.png" alt="Logo" className="w-[32px] h-[32px]" />
            </div>
            <div className="flex flex-col gap-1">
          ...
          <div className="w-[400px] h-auto p-4 gap-2 rounded-md bg-[#F7F7F7] flex">
            <div className="w-[80px] h-[80px] rounded-md bg-white flex items-center justify-center">
              <Image src="/images/book (2).png" alt="Logo" className="w-[32px] h-[32px]" />
            </div>
            <div className="flex flex-col gap-1">
